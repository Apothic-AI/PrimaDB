# OPFS Segment Regression

This browser-only regression page verifies that package OPFS segment persistence writes incremental transactions after the initial full flush.
